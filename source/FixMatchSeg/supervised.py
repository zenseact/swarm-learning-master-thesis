...
def run_supervised():
    ...
    # train supervised
    trainer = train(model, completeTrainloader, completeValloader, nr_epochs=3)
...
def pred():
    ...
    model = PetModel.load_from_checkpoint(checkpoint_path=checkpoint_path, arch="FPN", encoder_name="resnet34", in_channels=3, out_classes=1)
