...
class SwarmClient:
    ...
    def __init__(
        ...
        # get own ip address and port from the config and start the server
        client_ip, client_port = SwarmClient.get_client_address(swarm_config, cid)
        self.address = f"http://{client_ip}:{client_port}"
