...
def main():
    ...
    parser.add_argument("--nr_clients", default=NUM_CLIENTS, type=int, required=False)
    parser.add_argument(
        "--nr_local_epochs", default=NUM_LOCAL_EPOCHS, type=int, required=False
    )
    parser.add_argument(
        "--nr_global_rounds", default=NUM_GLOBAL_ROUNDS, type=int, required=False
    )
    parser.add_argument(
        "--subset_factor", default=SUBSET_FACTOR, type=float, required=False
    )
    parser.add_argument("--val_factor", default=VAL_FACTOR, type=float, required=False)
    parser.add_argument("--img_size", default=IMG_SIZE, type=int, required=False)
    parser.add_argument("--batch_size", default=BATCH_SIZE, type=int, required=False)
